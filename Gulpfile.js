...
gulp.task('templates', function(){
  return gulp.src('app/scripts/**/*.tpl.html')
    .pipe(html2js({
      outputModuleName: 'ctsng.templates',
      useStrict: true,
...
// Live Reload - mini-server for changes to JS files that updates Chrome
// Similar to AutoBuilds+AutoDeploys+JRebel
